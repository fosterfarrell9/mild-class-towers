...
Imaginary quadratic field of discriminant `-163004039`, class group `[252,18,3]`,
...
verifier/verify_certificate certificates/p3/016/K-163004039-p3/certificate.gp   # from the repository root
```
