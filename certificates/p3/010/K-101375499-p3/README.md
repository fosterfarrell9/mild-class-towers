...
Imaginary quadratic field of discriminant `-101375499`, class group `[72,9,3]`,
...
verifier/verify_certificate certificates/p3/010/K-101375499-p3/certificate.gp   # from the repository root
```
