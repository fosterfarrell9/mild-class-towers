...
Imaginary quadratic field of discriminant `-4447704`, class group `[24,6,6]`,
...
verifier/verify_certificate certificates/p3/000/K-4447704-p3/certificate.gp   # from the repository root
```
