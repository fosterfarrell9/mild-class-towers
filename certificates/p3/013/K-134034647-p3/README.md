...
Imaginary quadratic field of discriminant `-134034647`, class group `[90,18,6]`,
...
verifier/verify_certificate certificates/p3/013/K-134034647-p3/certificate.gp   # from the repository root
```
