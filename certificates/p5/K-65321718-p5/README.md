# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-65321718})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 65321718 = 0
disc(K) = -261286872
Cl(K) = [10,10,10,2,2]
```
...
verifier/verify_certificate certificates/p5/K-65321718-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-65321718-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-65321718-p5 && pdflatex certificate-guide.tex
```
