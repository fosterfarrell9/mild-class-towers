# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-195480601})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 195480601 = 0
disc(K) = -781922404
Cl(K) = [120,15,5]
```

(The directory is named after the radicand 195480601; the
discriminant is \(4\cdot(-195480601)=-781922404\).)
...
verifier/verify_certificate certificates/p5/K-195480601-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-195480601-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-195480601-p5 && pdflatex certificate-guide.tex
```
