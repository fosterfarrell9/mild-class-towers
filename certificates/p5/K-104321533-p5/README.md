# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-104321533})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 104321533 = 0
disc(K) = -417286132
Cl(K) = [110,10,5]
```

(The directory is named after the radicand 104321533; the
discriminant is \(4\cdot(-104321533)=-417286132\).)
...
verifier/verify_certificate certificates/p5/K-104321533-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-104321533-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-104321533-p5 && pdflatex certificate-guide.tex
```
