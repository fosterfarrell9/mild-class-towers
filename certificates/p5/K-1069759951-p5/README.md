# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-1069759951})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 1069759951 = 0
disc(K) = -1069759951
Cl(K) = [360,10,5]
```
...
verifier/verify_certificate certificates/p5/K-1069759951-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-1069759951-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-1069759951-p5 && pdflatex certificate-guide.tex
```
