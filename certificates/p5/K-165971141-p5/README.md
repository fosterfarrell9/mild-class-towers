# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-165971141})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 165971141 = 0
disc(K) = -663884564
Cl(K) = [140,10,10]
```

(The directory is named after the radicand 165971141; the
discriminant is \(4\cdot(-165971141)=-663884564\).)
...
verifier/verify_certificate certificates/p5/K-165971141-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-165971141-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-165971141-p5 && pdflatex certificate-guide.tex
```
