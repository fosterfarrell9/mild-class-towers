# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-116836878})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 116836878 = 0
disc(K) = -467347512
Cl(K) = [20,10,10,2]
```

(The directory is named after the radicand 116836878; the
discriminant is \(4\cdot(-116836878)=-467347512\).)
...
verifier/verify_certificate certificates/p5/K-116836878-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-116836878-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-116836878-p5 && pdflatex certificate-guide.tex
```
