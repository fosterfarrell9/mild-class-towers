# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-162062266})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 162062266 = 0
disc(K) = -648249064
Cl(K) = [70,10,10]
```

(The directory is named after the radicand 162062266; the
discriminant is \(4\cdot(-162062266)=-648249064\).)
...
verifier/verify_certificate certificates/p5/K-162062266-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-162062266-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-162062266-p5 && pdflatex certificate-guide.tex
```
