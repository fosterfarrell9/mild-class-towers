# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-163733006})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 163733006 = 0
disc(K) = -654932024
Cl(K) = [330,10,5]
```

(The directory is named after the radicand 163733006; the
discriminant is \(4\cdot(-163733006)=-654932024\).)
...
verifier/verify_certificate certificates/p5/K-163733006-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-163733006-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-163733006-p5 && pdflatex certificate-guide.tex
```
