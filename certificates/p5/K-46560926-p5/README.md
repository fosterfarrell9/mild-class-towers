# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-46560926})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 46560926 = 0
disc(K) = -186243704
Cl(K) = [40,20,10]
```
...
verifier/verify_certificate certificates/p5/K-46560926-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-46560926-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-46560926-p5 && pdflatex certificate-guide.tex
```
