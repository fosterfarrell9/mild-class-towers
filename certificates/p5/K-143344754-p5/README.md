# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-143344754})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 143344754 = 0
disc(K) = -573379016
Cl(K) = [60,10,10,2]
```

(The directory is named after the radicand 143344754; the
discriminant is \(4\cdot(-143344754)=-573379016\).)
...
verifier/verify_certificate certificates/p5/K-143344754-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-143344754-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-143344754-p5 && pdflatex certificate-guide.tex
```
