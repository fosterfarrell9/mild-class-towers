...
`records/p5/transverse-rank-one/`).  The certificate pins down the
...
verifier/verify_certificate certificates/p5/K-126740891-p5/certificate.gp \
  ../records/p5/further/D-126740891/result.gp
```
...
```sh
CERT_DIR=certificates/p5/K-126740891-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-126740891-p5 && pdflatex certificate-guide.tex
```
