# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-220028102})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 220028102 = 0
disc(K) = -880112408
Cl(K) = [270,10,5]
```

(The directory is named after the radicand 220028102; the
discriminant is \(4\cdot(-220028102)=-880112408\).)
...
verifier/verify_certificate certificates/p5/K-220028102-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-220028102-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-220028102-p5 && pdflatex certificate-guide.tex
```
