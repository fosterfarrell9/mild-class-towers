# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-108521041})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 108521041 = 0
disc(K) = -434084164
Cl(K) = [300,5,5]
```

(The directory is named after the radicand 108521041; the
discriminant is \(4\cdot(-108521041)=-434084164\).)
...
verifier/verify_certificate certificates/p5/K-108521041-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-108521041-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-108521041-p5 && pdflatex certificate-guide.tex
```
