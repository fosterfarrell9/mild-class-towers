# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-85894009})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 85894009 = 0
disc(K) = -343576036
Cl(K) = [220,5,5]
```

(The directory is named after the radicand 85894009; the
discriminant is \(4\cdot(-85894009)=-343576036\).)
...
verifier/verify_certificate certificates/p5/K-85894009-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-85894009-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-85894009-p5 && pdflatex certificate-guide.tex
```
