# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-848798407})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 848798407 = 0
disc(K) = -848798407
Cl(K) = [375,5,5]
```
...
verifier/verify_certificate certificates/p5/K-848798407-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-848798407-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-848798407-p5 && pdflatex certificate-guide.tex
```
