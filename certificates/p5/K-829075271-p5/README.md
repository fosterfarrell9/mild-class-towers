# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-829075271})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 829075271 = 0
disc(K) = -829075271
Cl(K) = [1490,5,5]
```
...
verifier/verify_certificate certificates/p5/K-829075271-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-829075271-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-829075271-p5 && pdflatex certificate-guide.tex
```
