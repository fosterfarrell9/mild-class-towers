# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-208239234})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 208239234 = 0
disc(K) = -832956936
Cl(K) = [50,10,10,2]
```

(The directory is named after the radicand 208239234; the
discriminant is \(4\cdot(-208239234)=-832956936\).)
...
verifier/verify_certificate certificates/p5/K-208239234-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-208239234-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-208239234-p5 && pdflatex certificate-guide.tex
```
