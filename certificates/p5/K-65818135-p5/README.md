...
verifier/verify_certificate certificates/p5/K-65818135-p5/certificate.gp \
  ../records/p5/batch-block0-01/D-65818135/result.gp
```
...
```sh
CERT_DIR=certificates/p5/K-65818135-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-65818135-p5 && pdflatex certificate-guide.tex
```
