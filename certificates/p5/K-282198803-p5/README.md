# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-282198803})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 282198803 = 0
disc(K) = -282198803
Cl(K) = [120,10,5]
```
...
verifier/verify_certificate certificates/p5/K-282198803-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-282198803-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-282198803-p5 && pdflatex certificate-guide.tex
```
