# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-136468326})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 136468326 = 0
disc(K) = -545873304
Cl(K) = [70,10,10]
```

(The directory is named after the radicand 136468326; the
discriminant is \(4\cdot(-136468326)=-545873304\).)
...
verifier/verify_certificate certificates/p5/K-136468326-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-136468326-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-136468326-p5 && pdflatex certificate-guide.tex
```
