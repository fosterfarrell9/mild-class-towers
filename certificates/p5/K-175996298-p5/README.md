# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-175996298})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 175996298 = 0
disc(K) = -703985192
Cl(K) = [390,5,5]
```

(The directory is named after the radicand 175996298; the
discriminant is \(4\cdot(-175996298)=-703985192\).)
...
verifier/verify_certificate certificates/p5/K-175996298-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-175996298-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-175996298-p5 && pdflatex certificate-guide.tex
```
