# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-202331347})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 202331347 = 0
disc(K) = -202331347
Cl(K) = [30,10,5]
```
...
verifier/verify_certificate certificates/p5/K-202331347-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-202331347-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-202331347-p5 && pdflatex certificate-guide.tex
```
