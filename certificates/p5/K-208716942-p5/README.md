# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-208716942})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 208716942 = 0
disc(K) = -834867768
Cl(K) = [30,10,10,2]
```

(The directory is named after the radicand 208716942; the
discriminant is \(4\cdot(-208716942)=-834867768\).)
...
verifier/verify_certificate certificates/p5/K-208716942-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-208716942-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-208716942-p5 && pdflatex certificate-guide.tex
```
