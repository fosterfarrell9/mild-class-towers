# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-873927415})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 873927415 = 0
disc(K) = -873927415
Cl(K) = [240,10,5]
```
...
verifier/verify_certificate certificates/p5/K-873927415-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-873927415-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-873927415-p5 && pdflatex certificate-guide.tex
```
