# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-752704467})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 752704467 = 0
disc(K) = -752704467
Cl(K) = [130,5,5]
```
...
verifier/verify_certificate certificates/p5/K-752704467-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-752704467-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-752704467-p5 && pdflatex certificate-guide.tex
```
