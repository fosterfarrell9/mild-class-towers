# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-890032871})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 890032871 = 0
disc(K) = -890032871
Cl(K) = [750,10,5]
```
...
verifier/verify_certificate certificates/p5/K-890032871-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-890032871-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-890032871-p5 && pdflatex certificate-guide.tex
```
