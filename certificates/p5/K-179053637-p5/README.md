# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-179053637})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 179053637 = 0
disc(K) = -716214548
Cl(K) = [130,10,10]
```

(The directory is named after the radicand 179053637; the
discriminant is \(4\cdot(-179053637)=-716214548\).)
...
verifier/verify_certificate certificates/p5/K-179053637-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-179053637-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-179053637-p5 && pdflatex certificate-guide.tex
```
