# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-188415222})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 188415222 = 0
disc(K) = -753660888
Cl(K) = [60,10,10]
```

(The directory is named after the radicand 188415222; the
discriminant is \(4\cdot(-188415222)=-753660888\).)
...
verifier/verify_certificate certificates/p5/K-188415222-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-188415222-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-188415222-p5 && pdflatex certificate-guide.tex
```
