# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-190572839})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 190572839 = 0
disc(K) = -190572839
Cl(K) = [630,5,5]
```
...
verifier/verify_certificate certificates/p5/K-190572839-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-190572839-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-190572839-p5 && pdflatex certificate-guide.tex
```
