# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-232717805})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 232717805 = 0
disc(K) = -930871220
Cl(K) = [160,10,10]
```

(The directory is named after the radicand 232717805; the
discriminant is \(4\cdot(-232717805)=-930871220\).)
...
verifier/verify_certificate certificates/p5/K-232717805-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-232717805-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-232717805-p5 && pdflatex certificate-guide.tex
```
