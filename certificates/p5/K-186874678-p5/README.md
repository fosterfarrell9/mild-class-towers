# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-186874678})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 186874678 = 0
disc(K) = -747498712
Cl(K) = [100,10,5]
```

(The directory is named after the radicand 186874678; the
discriminant is \(4\cdot(-186874678)=-747498712\).)
...
verifier/verify_certificate certificates/p5/K-186874678-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-186874678-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-186874678-p5 && pdflatex certificate-guide.tex
```
