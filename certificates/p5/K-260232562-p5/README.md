# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-260232562})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 260232562 = 0
disc(K) = -1040930248
Cl(K) = [120,10,5]
```

(The directory is named after the radicand 260232562; the
discriminant is \(4\cdot(-260232562)=-1040930248\).)
...
verifier/verify_certificate certificates/p5/K-260232562-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-260232562-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-260232562-p5 && pdflatex certificate-guide.tex
```
