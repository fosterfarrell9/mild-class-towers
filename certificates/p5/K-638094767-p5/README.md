# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-638094767})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 638094767 = 0
disc(K) = -638094767
Cl(K) = [730,5,5]
```
...
verifier/verify_certificate certificates/p5/K-638094767-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-638094767-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-638094767-p5 && pdflatex certificate-guide.tex
```
