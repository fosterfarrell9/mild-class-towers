# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-130239353})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 130239353 = 0
disc(K) = -520957412
Cl(K) = [230,10,5]
```

(The directory is named after the radicand 130239353; the
discriminant is \(4\cdot(-130239353)=-520957412\).)
...
verifier/verify_certificate certificates/p5/K-130239353-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-130239353-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-130239353-p5 && pdflatex certificate-guide.tex
```
