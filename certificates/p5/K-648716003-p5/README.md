# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-648716003})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 648716003 = 0
disc(K) = -648716003
Cl(K) = [300,5,5]
```
...
verifier/verify_certificate certificates/p5/K-648716003-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-648716003-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-648716003-p5 && pdflatex certificate-guide.tex
```
