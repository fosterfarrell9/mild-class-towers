...
verifier/verify_certificate certificates/p5/K-123482119-p5/certificate.gp \
  ../records/p5/further/D-123482119/result.gp
```
...
```sh
CERT_DIR=certificates/p5/K-123482119-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-123482119-p5 && pdflatex certificate-guide.tex
```
