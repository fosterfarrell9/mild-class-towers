# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-124651981})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 124651981 = 0
disc(K) = -498607924
Cl(K) = [160,10,5]
```

(The directory is named after the radicand 124651981; the
discriminant is \(4\cdot(-124651981)=-498607924\).)
...
verifier/verify_certificate certificates/p5/K-124651981-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-124651981-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-124651981-p5 && pdflatex certificate-guide.tex
```
