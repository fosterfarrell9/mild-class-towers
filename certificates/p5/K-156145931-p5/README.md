# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-156145931})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 156145931 = 0
disc(K) = -156145931
Cl(K) = [165,5,5]
```
...
verifier/verify_certificate certificates/p5/K-156145931-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-156145931-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-156145931-p5 && pdflatex certificate-guide.tex
```
