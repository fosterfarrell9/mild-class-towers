# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-78266297})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 78266297 = 0
disc(K) = -313065188
Cl(K) = [140,10,5]
```

(The directory is named after the radicand 78266297; the
discriminant is \(4\cdot(-78266297)=-313065188\).)
...
verifier/verify_certificate certificates/p5/K-78266297-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-78266297-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-78266297-p5 && pdflatex certificate-guide.tex
```
