# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-56593357})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 56593357 = 0
disc(K) = -226373428
Cl(K) = [30,10,10]
```
...
verifier/verify_certificate certificates/p5/K-56593357-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-56593357-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-56593357-p5 && pdflatex certificate-guide.tex
```
