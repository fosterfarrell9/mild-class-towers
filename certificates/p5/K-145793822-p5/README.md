# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-145793822})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 145793822 = 0
disc(K) = -583175288
Cl(K) = [50,10,10,2]
```

(The directory is named after the radicand 145793822; the
discriminant is \(4\cdot(-145793822)=-583175288\).)
...
verifier/verify_certificate certificates/p5/K-145793822-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-145793822-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-145793822-p5 && pdflatex certificate-guide.tex
```
