# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-215933113})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 215933113 = 0
disc(K) = -863732452
Cl(K) = [90,10,5]
```

(The directory is named after the radicand 215933113; the
discriminant is \(4\cdot(-215933113)=-863732452\).)
...
verifier/verify_certificate certificates/p5/K-215933113-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-215933113-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-215933113-p5 && pdflatex certificate-guide.tex
```
