# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-91195165})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 91195165 = 0
disc(K) = -364780660
Cl(K) = [70,10,10]
```

(The directory is named after the radicand 91195165; the
discriminant is \(4\cdot(-91195165)=-364780660\).)
...
verifier/verify_certificate certificates/p5/K-91195165-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-91195165-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-91195165-p5 && pdflatex certificate-guide.tex
```
