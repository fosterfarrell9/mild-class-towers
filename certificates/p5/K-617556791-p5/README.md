# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-617556791})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 617556791 = 0
disc(K) = -617556791
Cl(K) = [270,10,10]
```
...
verifier/verify_certificate certificates/p5/K-617556791-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-617556791-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-617556791-p5 && pdflatex certificate-guide.tex
```
