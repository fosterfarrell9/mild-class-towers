# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-104087314})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 104087314 = 0
disc(K) = -416349256
Cl(K) = [40,10,10]
```

(The directory is named after the radicand 104087314; the
discriminant is \(4\cdot(-104087314)=-416349256\).)
...
verifier/verify_certificate certificates/p5/K-104087314-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-104087314-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-104087314-p5 && pdflatex certificate-guide.tex
```
