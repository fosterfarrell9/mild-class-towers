# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-82681834})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 82681834 = 0
disc(K) = -330727336
Cl(K) = [150,5,5]
```

(The directory is named after the radicand 82681834; the
discriminant is \(4\cdot(-82681834)=-330727336\).)
...
verifier/verify_certificate certificates/p5/K-82681834-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-82681834-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-82681834-p5 && pdflatex certificate-guide.tex
```
