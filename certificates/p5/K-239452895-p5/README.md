# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-239452895})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 239452895 = 0
disc(K) = -239452895
Cl(K) = [160,10,10]
```
...
verifier/verify_certificate certificates/p5/K-239452895-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-239452895-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-239452895-p5 && pdflatex certificate-guide.tex
```
