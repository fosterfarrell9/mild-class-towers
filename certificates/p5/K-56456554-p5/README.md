# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-56456554})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 56456554 = 0
disc(K) = -225826216
Cl(K) = [20,10,10,2]
```
...
verifier/verify_certificate certificates/p5/K-56456554-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-56456554-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-56456554-p5 && pdflatex certificate-guide.tex
```
