# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-979106379})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 979106379 = 0
disc(K) = -979106379
Cl(K) = [410,5,5]
```
...
verifier/verify_certificate certificates/p5/K-979106379-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-979106379-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-979106379-p5 && pdflatex certificate-guide.tex
```
