# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-253425979})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 253425979 = 0
disc(K) = -253425979
Cl(K) = [135,5,5]
```
...
verifier/verify_certificate certificates/p5/K-253425979-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-253425979-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-253425979-p5 && pdflatex certificate-guide.tex
```
