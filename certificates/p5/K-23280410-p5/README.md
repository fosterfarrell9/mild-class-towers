# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-23280410})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 23280410 = 0
disc(K) = -93121640
Cl(K) = [90, 10, 10]
```

(The directory is named after the radicand 23280410; the discriminant is 4*(-23280410) = -93121640.)
...
python3 run_parallel.py --polynomial 's^2+23280410' \
  --workdir work/D-93121640 --limit exhaustive
```
...
verifier/verify_certificate certificates/p5/K-23280410-p5/certificate.gp \
  ../records/p5/further/D-93121640/result.gp
```
...
```sh
CERT_DIR=certificates/p5/K-23280410-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-23280410-p5 && pdflatex certificate-guide.tex
```
