# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-163046954})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 163046954 = 0
disc(K) = -652187816
Cl(K) = [130,10,10]
```

(The directory is named after the radicand 163046954; the
discriminant is \(4\cdot(-163046954)=-652187816\).)
...
verifier/verify_certificate certificates/p5/K-163046954-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-163046954-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-163046954-p5 && pdflatex certificate-guide.tex
```
