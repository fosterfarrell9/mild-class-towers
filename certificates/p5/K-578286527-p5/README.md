# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-578286527})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 578286527 = 0
disc(K) = -578286527
Cl(K) = [110,10,10,2]
```
...
verifier/verify_certificate certificates/p5/K-578286527-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-578286527-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-578286527-p5 && pdflatex certificate-guide.tex
```
