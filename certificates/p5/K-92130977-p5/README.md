# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-92130977})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 92130977 = 0
disc(K) = -368523908
Cl(K) = [20,20,10,2]
```

(The directory is named after the radicand 92130977; the
discriminant is \(4\cdot(-92130977)=-368523908\).)
...
verifier/verify_certificate certificates/p5/K-92130977-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-92130977-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-92130977-p5 && pdflatex certificate-guide.tex
```
