...
verifier/verify_certificate certificates/p5/K-145367147-p5/certificate.gp \
  ../records/p5/batch-block0-01/D-145367147/result.gp
```
...
```sh
CERT_DIR=certificates/p5/K-145367147-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-145367147-p5 && pdflatex certificate-guide.tex
```
