# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-220463086})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 220463086 = 0
disc(K) = -881852344
Cl(K) = [80,20,5]
```

(The directory is named after the radicand 220463086; the
discriminant is \(4\cdot(-220463086)=-881852344\).)
...
verifier/verify_certificate certificates/p5/K-220463086-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-220463086-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-220463086-p5 && pdflatex certificate-guide.tex
```
