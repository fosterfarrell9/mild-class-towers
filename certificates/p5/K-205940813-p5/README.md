# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-205940813})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 205940813 = 0
disc(K) = -823763252
Cl(K) = [200,10,5]
```

(The directory is named after the radicand 205940813; the
discriminant is \(4\cdot(-205940813)=-823763252\).)
...
verifier/verify_certificate certificates/p5/K-205940813-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-205940813-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-205940813-p5 && pdflatex certificate-guide.tex
```
