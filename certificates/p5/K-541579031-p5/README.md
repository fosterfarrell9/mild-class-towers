# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-541579031})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 541579031 = 0
disc(K) = -541579031
Cl(K) = [280,10,10]
```
...
verifier/verify_certificate certificates/p5/K-541579031-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-541579031-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-541579031-p5 && pdflatex certificate-guide.tex
```
