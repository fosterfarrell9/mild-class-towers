# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-469835647})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 469835647 = 0
disc(K) = -469835647
Cl(K) = [80,20,5]
```
...
verifier/verify_certificate certificates/p5/K-469835647-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-469835647-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-469835647-p5 && pdflatex certificate-guide.tex
```
