# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-51227486})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 51227486 = 0
disc(K) = -204909944
Cl(K) = [80,10,10]
```
...
verifier/verify_certificate certificates/p5/K-51227486-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-51227486-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-51227486-p5 && pdflatex certificate-guide.tex
```
