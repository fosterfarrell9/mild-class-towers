...
verifier/verify_certificate certificates/p5/K-964632455-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-964632455-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-964632455-p5 && pdflatex certificate-guide.tex
```
