# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-249138670})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 249138670 = 0
disc(K) = -996554680
Cl(K) = [60,10,10]
```

(The directory is named after the radicand 249138670; the
discriminant is \(4\cdot(-249138670)=-996554680\).)
...
verifier/verify_certificate certificates/p5/K-249138670-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-249138670-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-249138670-p5 && pdflatex certificate-guide.tex
```
