# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-207666763})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 - s + 51916691 = 0
disc(K) = -207666763
Cl(K) = [50, 10, 5]
```
...
python3 run_parallel.py --polynomial 's^2-s+51916691' \
  --workdir work/D-207666763 --limit exhaustive
```
...
verifier/verify_certificate certificates/p5/K-207666763-p5/certificate.gp \
  ../records/p5/batch-block0-01/D-207666763/result.gp
```
...
```sh
CERT_DIR=certificates/p5/K-207666763-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-207666763-p5 && pdflatex certificate-guide.tex
```
