# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-172607290})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 172607290 = 0
disc(K) = -690429160
Cl(K) = [20,10,10,2]
```

(The directory is named after the radicand 172607290; the
discriminant is \(4\cdot(-172607290)=-690429160\).)
...
verifier/verify_certificate certificates/p5/K-172607290-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-172607290-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-172607290-p5 && pdflatex certificate-guide.tex
```
