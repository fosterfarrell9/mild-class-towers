# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-730579195})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 730579195 = 0
disc(K) = -730579195
Cl(K) = [40,20,5]
```
...
verifier/verify_certificate certificates/p5/K-730579195-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-730579195-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-730579195-p5 && pdflatex certificate-guide.tex
```
