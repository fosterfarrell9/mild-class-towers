# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-131933562})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 131933562 = 0
disc(K) = -527734248
Cl(K) = [80,10,10]
```

(The directory is named after the radicand 131933562; the
discriminant is \(4\cdot(-131933562)=-527734248\).)
...
verifier/verify_certificate certificates/p5/K-131933562-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-131933562-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-131933562-p5 && pdflatex certificate-guide.tex
```
