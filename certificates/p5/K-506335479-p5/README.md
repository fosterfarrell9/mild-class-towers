# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-506335479})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 506335479 = 0
disc(K) = -506335479
Cl(K) = [190,10,10]
```
...
verifier/verify_certificate certificates/p5/K-506335479-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-506335479-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-506335479-p5 && pdflatex certificate-guide.tex
```
