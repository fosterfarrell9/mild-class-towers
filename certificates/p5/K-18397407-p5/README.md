...
```sh
MASSEY_CERTIFICATE_EXPORT="$PWD/certificates/p5/K-18397407-p5/certificate.gp" \
...
`records/p5/D-18397407/result.gp` exactly; only the certificate was
kept.
...
verifier/verify_certificate certificates/p5/K-18397407-p5/certificate.gp \
  ../records/p5/D-18397407/result.gp
```
...
```sh
CERT_DIR=certificates/p5/K-18397407-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-18397407-p5 && pdflatex certificate-guide.tex
```
