# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-215215589})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 215215589 = 0
disc(K) = -860862356
Cl(K) = [710,5,5]
```

(The directory is named after the radicand 215215589; the
discriminant is \(4\cdot(-215215589)=-860862356\).)
...
verifier/verify_certificate certificates/p5/K-215215589-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-215215589-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-215215589-p5 && pdflatex certificate-guide.tex
```
