# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-61040707})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 - s + 15260177 = 0
disc(K) = -61040707
Cl(K) = [20, 10, 5]
```
...
`records/p5/batch-block0-01/D-61040707/result.gp` exactly; only the
...
verifier/verify_certificate certificates/p5/K-61040707-p5/certificate.gp \
  ../records/p5/batch-block0-01/D-61040707/result.gp
```
...
```sh
CERT_DIR=certificates/p5/K-61040707-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-61040707-p5 && pdflatex certificate-guide.tex
```
