# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-257676258})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 257676258 = 0
disc(K) = -1030705032
Cl(K) = [40,10,10,2]
```

(The directory is named after the radicand 257676258; the
discriminant is \(4\cdot(-257676258)=-1030705032\).)
...
verifier/verify_certificate certificates/p5/K-257676258-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-257676258-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-257676258-p5 && pdflatex certificate-guide.tex
```
