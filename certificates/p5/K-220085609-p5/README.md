# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-220085609})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 220085609 = 0
disc(K) = -880342436
Cl(K) = [660,5,5]
```

(The directory is named after the radicand 220085609; the
discriminant is \(4\cdot(-220085609)=-880342436\).)
...
verifier/verify_certificate certificates/p5/K-220085609-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-220085609-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-220085609-p5 && pdflatex certificate-guide.tex
```
