# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-252893513})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 252893513 = 0
disc(K) = -1011574052
Cl(K) = [60,20,10]
```

(The directory is named after the radicand 252893513; the
discriminant is \(4\cdot(-252893513)=-1011574052\).)
...
verifier/verify_certificate certificates/p5/K-252893513-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-252893513-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-252893513-p5 && pdflatex certificate-guide.tex
```
