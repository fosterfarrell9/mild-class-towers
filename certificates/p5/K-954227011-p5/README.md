# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-954227011})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 954227011 = 0
disc(K) = -954227011
Cl(K) = [270,5,5]
```
...
verifier/verify_certificate certificates/p5/K-954227011-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-954227011-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-954227011-p5 && pdflatex certificate-guide.tex
```
