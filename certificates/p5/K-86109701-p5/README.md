# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-86109701})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 86109701 = 0
disc(K) = -344438804
Cl(K) = [300,10,5]
```

(The directory is named after the radicand 86109701; the
discriminant is \(4\cdot(-86109701)=-344438804\).)
...
verifier/verify_certificate certificates/p5/K-86109701-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-86109701-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-86109701-p5 && pdflatex certificate-guide.tex
```
