# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-112094129})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 112094129 = 0
disc(K) = -448376516
Cl(K) = [110,10,10]
```

(The directory is named after the radicand 112094129; the
discriminant is \(4\cdot(-112094129)=-448376516\).)
...
verifier/verify_certificate certificates/p5/K-112094129-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-112094129-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-112094129-p5 && pdflatex certificate-guide.tex
```
