# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-254212081})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 254212081 = 0
disc(K) = -1016848324
Cl(K) = [300,5,5]
```

(The directory is named after the radicand 254212081; the
discriminant is \(4\cdot(-254212081)=-1016848324\).)
...
verifier/verify_certificate certificates/p5/K-254212081-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-254212081-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-254212081-p5 && pdflatex certificate-guide.tex
```
