# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-48520202})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 48520202 = 0
disc(K) = -194080808
Cl(K) = [70,10,10]
```
...
verifier/verify_certificate certificates/p5/K-48520202-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-48520202-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-48520202-p5 && pdflatex certificate-guide.tex
```
