...
`records/p5/batch-block0-01/D-54319112/result.gp` exactly; only the
...
verifier/verify_certificate certificates/p5/K-13579778-p5/certificate.gp \
  ../records/p5/batch-block0-01/D-54319112/result.gp
```
...
```sh
CERT_DIR=certificates/p5/K-13579778-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-13579778-p5 && pdflatex certificate-guide.tex
```
