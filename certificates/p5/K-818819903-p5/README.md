# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-818819903})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 818819903 = 0
disc(K) = -818819903
Cl(K) = [320,10,5]
```
...
verifier/verify_certificate certificates/p5/K-818819903-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-818819903-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-818819903-p5 && pdflatex certificate-guide.tex
```
