# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-128144657})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 128144657 = 0
disc(K) = -512578628
Cl(K) = [80,10,10]
```

(The directory is named after the radicand 128144657; the
discriminant is \(4\cdot(-128144657)=-512578628\).)
...
verifier/verify_certificate certificates/p5/K-128144657-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-128144657-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-128144657-p5 && pdflatex certificate-guide.tex
```
