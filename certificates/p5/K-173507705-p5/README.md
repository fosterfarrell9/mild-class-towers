# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-173507705})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 173507705 = 0
disc(K) = -694030820
Cl(K) = [130,10,10]
```

(The directory is named after the radicand 173507705; the
discriminant is \(4\cdot(-173507705)=-694030820\).)
...
verifier/verify_certificate certificates/p5/K-173507705-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-173507705-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-173507705-p5 && pdflatex certificate-guide.tex
```
