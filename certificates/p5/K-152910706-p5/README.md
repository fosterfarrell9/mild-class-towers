# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-152910706})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 152910706 = 0
disc(K) = -611642824
Cl(K) = [50,10,10]
```

(The directory is named after the radicand 152910706; the
discriminant is \(4\cdot(-152910706)=-611642824\).)
...
verifier/verify_certificate certificates/p5/K-152910706-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-152910706-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-152910706-p5 && pdflatex certificate-guide.tex
```
