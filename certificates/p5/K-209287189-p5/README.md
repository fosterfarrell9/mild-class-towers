# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-209287189})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 209287189 = 0
disc(K) = -837148756
Cl(K) = [150,10,5]
```

(The directory is named after the radicand 209287189; the
discriminant is \(4\cdot(-209287189)=-837148756\).)
...
verifier/verify_certificate certificates/p5/K-209287189-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-209287189-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-209287189-p5 && pdflatex certificate-guide.tex
```
