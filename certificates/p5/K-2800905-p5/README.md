...
- `certificate.gp` is a textual, PARI-readable certificate. It contains the
  ...
  entries remain in the repository history.)
...
MASSEY_CERTIFICATE_EXPORT=certificates/p5/K-2800905-p5/certificate.gp \
...
cd certificates/p5/K-2800905-p5 && pdflatex certificate-guide.tex
```
