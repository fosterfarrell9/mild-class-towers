# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-516168299})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 516168299 = 0
disc(K) = -516168299
Cl(K) = [450,5,5]
```
...
verifier/verify_certificate certificates/p5/K-516168299-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-516168299-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-516168299-p5 && pdflatex certificate-guide.tex
```
