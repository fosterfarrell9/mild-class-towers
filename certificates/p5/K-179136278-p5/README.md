# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-179136278})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 179136278 = 0
disc(K) = -716545112
Cl(K) = [310,10,5]
```

(The directory is named after the radicand 179136278; the
discriminant is \(4\cdot(-179136278)=-716545112\).)
...
verifier/verify_certificate certificates/p5/K-179136278-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-179136278-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-179136278-p5 && pdflatex certificate-guide.tex
```
