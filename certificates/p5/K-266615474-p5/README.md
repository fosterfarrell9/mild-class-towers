# Arithmetic certificate for \(K=\mathbf Q(\sqrt{-266615474})\), \(p=5\)

Certificate for the secondary-norm matrices of the field with

```text
p = 5
K = Q(s), s^2 + 266615474 = 0
disc(K) = -1066461896
Cl(K) = [330,10,5]
```

(The directory is named after the radicand 266615474; the
discriminant is \(4\cdot(-266615474)=-1066461896\).)
...
verifier/verify_certificate certificates/p5/K-266615474-p5/certificate.gp
```
...
```sh
CERT_DIR=certificates/p5/K-266615474-p5 gp -qf tools/certificate_guide.gp
cd certificates/p5/K-266615474-p5 && pdflatex certificate-guide.tex
```
