...
The imaginary quadratic field with D_K = -18561189299 has class group of
invariants [1674, 3, 3, 3], class number 45198, and elementary quotient of
...
Theta matrix = [2, 0; 2, 0; 1, 1],  rank 2  (surjective)
```
...
- `anick.log` --- an independent combinatorial confirmation: a
  change of basis g = [[1,0,1,2], [0,0,2,0], [1,2,1,0], [0,2,0,0]] under which the four cubic initial forms
  have the combinatorially free leading multidegrees (3,3,1), (3,3,0), (3,2,1), (3,2,0), so
...
- `gb.log` --- a truncated Groebner basis to degree 10: 5 elements, of degrees 3, 3, 3, 3, 4.
...
```sh
cd records/p3/rank-four-18561189299
DISC=-18561189299 gp -q pre.gp
