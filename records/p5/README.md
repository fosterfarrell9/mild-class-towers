...
are certified directly in `certificates/p5/` (204 fields in total).
...
documented and certified in `certificates/p5/K-2800905-p5/` (with the six
...
10  -77778287    (further/; computed across two machines, see
                  certificates/p5/K-77778287-p5/README.md)
11  -89017304    (further/)
12  -89218664    (further/)
13  -90903207    (further/)
14  -93121640    (further/)
...
Every computed field has an arithmetic certificate under `certificates/p5/`.
