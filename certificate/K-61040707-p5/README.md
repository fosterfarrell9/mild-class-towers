...
`examples/p5/batch-block0-01/D-61040707/result.gp` exactly; only the
...
verifier/verify_certificate certificate/K-61040707-p5/certificate.gp \
  ../examples/p5/batch-block0-01/D-61040707/result.gp
```
...
```sh
CERT_DIR=certificate/K-61040707-p5 gp -qf tools/certificate_guide.gp
cd certificate/K-61040707-p5 && pdflatex certificate-guide.tex
```
