...
verifier/verify_certificate certificate/K-106660295-p5/certificate.gp \
  ../examples/p5/further/D-106660295/result.gp
```
...
```sh
CERT_DIR=certificate/K-106660295-p5 gp -qf tools/certificate_guide.gp
cd certificate/K-106660295-p5 && pdflatex certificate-guide.tex
```
