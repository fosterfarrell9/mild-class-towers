...
verifier/verify_certificate certificate/K-87000789-p5/certificate.gp
```
...
```sh
CERT_DIR=certificate/K-87000789-p5 gp -qf tools/certificate_guide.gp
cd certificate/K-87000789-p5 && pdflatex certificate-guide.tex
```
