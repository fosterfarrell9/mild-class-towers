...
verifier/verify_certificate certificate/K-207666763-p5/certificate.gp \
  ../examples/p5/batch-block0-01/D-207666763/result.gp
```
...
```sh
CERT_DIR=certificate/K-207666763-p5 gp -qf tools/certificate_guide.gp
cd certificate/K-207666763-p5 && pdflatex certificate-guide.tex
```
