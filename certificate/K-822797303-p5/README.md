...
verifier/verify_certificate certificate/K-822797303-p5/certificate.gp
```
...
```sh
CERT_DIR=certificate/K-822797303-p5 gp -qf tools/certificate_guide.gp
cd certificate/K-822797303-p5 && pdflatex certificate-guide.tex
```
